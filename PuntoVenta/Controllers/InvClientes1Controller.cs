...
{
    public class InvClientes1Controller : Controller
    {
        private readonly InventarioPuntoventaContext _context;

        public InvClientes1Controller(InventarioPuntoventaContext context)
        {
            _context = context;
        }
        ...
        // GET: InvClientes1/Create
        public IActionResult Create()
        {
            return View();
        }

        // POST: InvClientes1/Create
